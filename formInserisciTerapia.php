...
<html>
	<head>
		...
		<script src='jsInserisciTerapia.js'></script>
	</head>
...
<?php 	if(isset($_SESSION['privilegio'])) { 
			if($_SESSION['privilegio'] == "veterinario") {
				...
				<h1>Inserisci terapia</h1>
				<form name="form" onsubmit="return checkFieldTerapiaAnimale()" method="post" action="inserisciTerapiaDataBase.php">
...
<?php //riempi select con nome del gatto da adottare 
					...
					<h3>Dati terapia</h3>
					Data inizio <input type="date" name="dataInizio" id="dataInizioId"><br/>
					Data fine <input type="date" name="dataFine" id="dataFineId"><br/>
